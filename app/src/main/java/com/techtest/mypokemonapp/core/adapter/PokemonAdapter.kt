...
import com.techtest.mypokemonapp.core.utils.Constant
...
class PokemonAdapter : ListAdapter<PokemonEntity, PokemonAdapter.ViewHolder>(DiffCallback) {
            ...
            binding.apply {
                ...
                itemView.setOnClickListener {
                    val intent = Intent(itemView.context, DetailActivity::class.java).apply {
                        putExtra(Constant.EXTRA_ID, pokemon.id)
                    }
